	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 WorldPosition102_g68747 = PositionWS;
				float2 ScreenUV102_g68747 = (ScreenPosNorm).xy;
				float3 WorldNormal102_g68747 = Normal_WS1160_g1;
				float3 ViewDir_WS1115_g1 = ViewDirWS;
				float3 ViewDirection102_g68747 = ViewDir_WS1115_g1;
				half4 localCalculateShadowMask2741_g1 = CalculateShadowMask2741_g1();
				float4 ShadowMask102_g68747 = localCalculateShadowMask2741_g1;
				float3x3 localAdditionalLightsData171x102_g68747 = AdditionalLightsData171x( WorldPosition102_g68747 , ScreenUV102_g68747 , WorldNormal102_g68747 , ViewDirection102_g68747 , ShadowMask102_g68747 );
				float3 break72_g68747 = localAdditionalLightsData171x102_g68747[ 0 ];
				...
				float3 break74_g68747 = localAdditionalLightsData171x102_g68747[ 1 ];
				...
				float3 Scene_Lighting1527_g1 = max( localAdditionalLightsData171x102_g68747[ 2 ] , temp_output_1609_0_g1 );
...
ASEEND*/
//CHKSM=B0835442B94D2C240CF731777EBD8BA61BB22833