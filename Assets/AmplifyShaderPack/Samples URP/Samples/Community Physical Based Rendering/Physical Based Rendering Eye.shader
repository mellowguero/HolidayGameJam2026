	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 WorldPosition102_g69862 = PositionWS;
				float2 ScreenUV102_g69862 = (ScreenPosNorm).xy;
				float3 WorldNormal102_g69862 = Normal_WS1160_g69747;
				float3 ViewDir_WS1115_g69747 = ViewDirWS;
				float3 ViewDirection102_g69862 = ViewDir_WS1115_g69747;
				half4 localCalculateShadowMask2741_g69747 = CalculateShadowMask2741_g69747();
				float4 ShadowMask102_g69862 = localCalculateShadowMask2741_g69747;
				float3x3 localAdditionalLightsData171x102_g69862 = AdditionalLightsData171x( WorldPosition102_g69862 , ScreenUV102_g69862 , WorldNormal102_g69862 , ViewDirection102_g69862 , ShadowMask102_g69862 );
				float3 break72_g69862 = localAdditionalLightsData171x102_g69862[ 0 ];
				...
				float3 break74_g69862 = localAdditionalLightsData171x102_g69862[ 1 ];
				...
				float3 Scene_Lighting1527_g69747 = max( localAdditionalLightsData171x102_g69862[ 2 ] , temp_output_1609_0_g69747 );
...
ASEEND*/
//CHKSM=321F174306117EEF3B9BA1F8022305C28CCE5D49